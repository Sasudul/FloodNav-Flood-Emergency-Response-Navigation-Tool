...
public class GraphInitializer implements CommandLineRunner {
    ...
    private void initializeRescueBase() {
        ...
        // Clear old bases and re-create with correct locations on every startup
        rescueBaseRepository.deleteAll();

        // Base 1: Kelaniya Rescue Base — near KEL111 (Thambiligasmulla Rd)
        RescueBase base1 = new RescueBase();
        base1.setName("Kelaniya Rescue Base");
        base1.setLatitude(6.984036);
        base1.setLongitude(79.932944);
        base1.setAvailableTeams(5);
        rescueBaseRepository.save(base1);

        // Base 2: Asiri Rescue Base — near KEL38 (Mahena Rd)
        RescueBase base2 = new RescueBase();
        base2.setName("Asiri Rescue Base");
        base2.setLatitude(6.952413);
        base2.setLongitude(79.97641);
        base2.setAvailableTeams(5);
        rescueBaseRepository.save(base2);

        System.out.println("✓ Created 2 rescue bases: Kelaniya (6.984036, 79.932944) & Asiri (6.952413, 79.97641)");
    }
